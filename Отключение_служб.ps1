...
Set-Service AppHostSvc -StartupType Automatic
...
Set-Service aspnet_state -StartupType Manual
...
Set-Service c2wts -StartupType Manual
...
Set-Service DsRoleSvc -StartupType Manual
